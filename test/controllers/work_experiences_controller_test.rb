...
class WorkExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create work_experience" do
    assert_difference('WorkExperience.count') do
      post :create, work_experience: { end_date: @work_experience.end_date, field_id: @work_experience.field_id, start_date: @work_experience.start_date, user_id: @work_experience.user_id, work_type: @work_experience.work_type }
    end
  ...
  test "should update work_experience" do
    patch :update, id: @work_experience, work_experience: { end_date: @work_experience.end_date, field_id: @work_experience.field_id, start_date: @work_experience.start_date, user_id: @work_experience.user_id, work_type: @work_experience.work_type }
    assert_redirected_to work_experience_path(assigns(:work_experience))
  end
